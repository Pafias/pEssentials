...
public class ReachCommand extends ICommand {
    ...
    private void sendMessage(CommandSender sender, Player target, String value) {
        ...
        sender.sendMessage(CC.t("&6Reach &d" + action + " &6for &d" + target.getName()));
    }
    ...
    private boolean apply(CommandSender sender, Player target, String input) {
        ...
        AttributeInstance attribute = target.getAttribute(Attribute.ENTITY_INTERACTION_RANGE);
        if (attribute == null) {
