    ...
    public void commandHandler(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("fly") && sender.hasPermission("essentials.entity.fly")) {
            ...
            if (player.isInsideVehicle()) {
                ...
                for (Entity nearby : player.getNearbyEntities(5.0D, 5.0D, 5.0D)) {
            ...
            entity.setGravity(!entity.hasGravity());
            user.getPlayer().sendActionBar(CC.t("&6Entity gravity: &r" + (entity.hasGravity() ? "&aON" : "&cOFF")));
            ...
            entity.setInvulnerable(!entity.isInvulnerable());
            user.getPlayer().sendActionBar(CC.t("&6Entity invulnerability: &r" + (entity.isInvulnerable() ? "&aON" : "&cOFF")));
            ...
            user.getPlayer().sendActionBar(CC.t("&6Entity glowing: &r" + (entity.isGlowing() ? "&aON" : "&cOFF")));
            ...
            if (args.length < 2) {
                ...
                user.getPlayer().sendActionBar(CC.t("&6Entity name visibility: " + (entity.isCustomNameVisible() ? "&aVISIBLE" : "&cINVISIBLE")));
                return;
            }
            ...
            user.getPlayer().sendActionBar(CC.t("&6Entity name: &r" + entity.getCustomName()));
            ...
            entity.setPassenger(player);
            user.getPlayer().sendActionBar(CC.t("&6Now riding: &b" + entity));
            ...
            user.getPlayer().sendActionBar(CC.t("&6Entity invisibility: " + (((LivingEntity) entity).isInvisible() ? "&7INVISIBLE" : "&bVISIBLE")));
            ...
            try {
                ...
                sender.sendMessage(CC.t("&6This entity does not have awareness"));
            }
            try {
                if (entity instanceof LivingEntity)
