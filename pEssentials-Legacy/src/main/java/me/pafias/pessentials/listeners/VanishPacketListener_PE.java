...
public class VanishPacketListener_PE extends SimplePacketListenerAbstract implements VanishPacketListener {

    private final VanishManager vanishManager;

    public VanishPacketListener_PE(VanishManager vanishManager) {
